...
describe('CacheService', () => {
  ...
  it('should clear cache at revoke', inject([CacheService], (cache) => {
    const http = TestBed.get(HttpTestingController);
    let response = front_page_response;
    cache.get('http://fake/Plone/').subscribe(() => {})
    http.expectOne('http://fake/Plone/').flush(response);
  ...
  it('should clear cache by key when revoke for key', inject([CacheService], (cache) => {
    const http = TestBed.get(HttpTestingController);
  ...
  it('should revoke the cache when user log in', inject([AuthenticationService, CacheService], (auth, cache) => {
    const http = TestBed.get(HttpTestingController);
    let response = front_page_response;
    cache.get('http://fake/Plone/').subscribe(content => {
    });
